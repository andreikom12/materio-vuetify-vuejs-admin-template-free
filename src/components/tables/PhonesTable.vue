    ...
    <template v-slot:top>
      <v-toolbar flat>
        ...
        <v-dialog v-model="dialogDelete" max-width="500px">
          <v-card>
            <v-card-title class="text-h5">Tem certeza que deseja deletar este telefone?</v-card-title>
            <v-card-actions>
              <v-spacer></v-spacer>
  ...
  methods: {
    ...
    save() {
      if (this.$refs.form.validate()) {
        ...
        this.$emit('update-phones', this.desserts)
        this.close()
      }
    },
  },
